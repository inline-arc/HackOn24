...
export default function Hero() {
    return (
        <>
        <div class="max-w-full mx-auto inset-0 -z-10 h-full w-full items-center px-5 py-16 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
