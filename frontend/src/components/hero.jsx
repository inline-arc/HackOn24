  ...
  <div class="absolute h-16 right-0 w-auto ml-10 -rotate-12 pt-20">
    ...
    <div class="relative py-4 flex justify-center px-4 sm:px-0">
      <div class="max-w-3xl text-center">
        ...
        <p className="side mt-4 text-md sm:text-sm leading-8 text-slate-100 sm:px-16 font-intan white-space: pre-line;">Empower news and media with cutting-edge blockchain technology, ensuring freedom, safety, and authenticity. Break free from centralized control and amplify genuine voices in journalism. And freedom for the truth</p>
