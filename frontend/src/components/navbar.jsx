...
export default function Navbar() {
    return (
        <>
        <div>
  <div class="mx-auto max-w-full py-4 lg:px-8 relative bg-black overflow-hidden">
